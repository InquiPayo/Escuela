	...
	<div class="row">
		<div class="panel panel-info col-md-3 ">
		     <div class="list-group ">
                <a href="#" class="list-group-item list-group-item-action active">Materias</a>
                <a href="#" class="list-group-item list-group-item-action">Español</a>
                ...
                <a href="#" class="list-group-item list-group-item-action">Fisica</a>
            </div> 
		</div>
