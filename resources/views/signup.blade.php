...
<div class="container" id="wrap">
    <div class="row">
      <div class="panel panel-info col-md-6 col-md-offset-3">
          <form action="r" method="post" accept-charset="utf-8" class="form" role="form">   <legend>Sign Up</legend>
                  <h4>Es gratis y siempre lo será.</h4>
                  <div class="row">
    ...
    <div class="row">
                   ...
                   <label>Genero:  </label> <label class="radio-inline">
            ...
            <span class="help-block">
                Al hacer clic en Crear mi cuenta, usted acepta nuestros Términos y que ha leído nuestra Política de uso de datos, incluido nuestro Uso de cookies.</span>
